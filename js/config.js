...
const WEATHER_CODES = {
  0: {
    desc: "Céu limpo",
    icon: '<i class="ph-fill ph-sun"></i>',
    color: "#FFD700",
    gradient: "linear-gradient(135deg, #f6d365 0%, #fda085 100%)",
  },
  1: {
    desc: "Principalmente limpo",
    icon: '<i class="ph-fill ph-cloud-sun"></i>',
    color: "#FDB813",
  ...
  3: {
    desc: "Nublado",
    icon: '<i class="ph-fill ph-cloud"></i>',
    color: "#8B8B8B",
    gradient: "linear-gradient(135deg, #d7d2cc 0%, #304352 100%)",
  },
  45: {
    desc: "Neblina",
    icon: '<i class="ph-fill ph-cloud-fog"></i>',
    color: "#B0C4DE",
  ...
  51: {
    desc: "Garoa leve",
    icon: '<i class="ph-fill ph-cloud-rain"></i>',
    color: "#4682B4",
  ...
  66: {
    ...
    icon: '<i class="ph-fill ph-cloud-snow"></i>',
    color: "#87CEEB",
  ...
  73: {
    desc: "Neve moderada",
    icon: '<i class="ph-fill ph-snowflake"></i>',
    color: "#E0FFFF",
  ...
  81: {
    ...
    icon: '<i class="ph-fill ph-cloud-lightning"></i>',
    color: "#4169E1",
    gradient: "linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)",
  },
  82: {
